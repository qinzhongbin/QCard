...
Java_com_qasky_qcard_QTF_enumDev(JNIEnv *env, jobject thiz, jstring pkg_name) {
...
Java_com_qasky_qcard_QTF_freeDevs(JNIEnv *env, jobject thiz) {
...
Java_com_qasky_qcard_QTF_loginDev(JNIEnv *env, jobject thiz, jlong dev_handle) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_qasky_qcard_QTF_logoutDev(JNIEnv *env, jobject thiz, jlong dev_handle) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_qasky_qcard_QTF_initResource(JNIEnv *env, jobject thiz, jlong dev_handle) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_qasky_qcard_QTF_updateResource(JNIEnv *env, jobject thiz, jlong dev_handle) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_qasky_qcard_QTF_destroyResource(JNIEnv *env, jobject thiz, jlong dev_handle) {
...
Java_com_qasky_qcard_QTF_getDeviceId(JNIEnv *env, jobject thiz, jlong dev_handle) {
    char storeId[64] = {0};
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_qasky_qcard_QTF_getSystemId(JNIEnv *env, jobject thiz, jlong dev_handle, jstring app_name, jstring con_name) {
...
extern "C"
JNIEXPORT jlongArray JNICALL
Java_com_qasky_qcard_QTF_queryKeyLength(JNIEnv *env, jobject thiz, jlong dev_handle, jstring app_name, jstring con_name) {
    char *appName = const_cast<char *>(env->GetStringUTFChars(app_name, JNI_FALSE));
    char *conName = const_cast<char *>(env->GetStringUTFChars(con_name, JNI_FALSE));
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_qasky_qcard_QTF_chargeKey(JNIEnv *env, jobject thiz, jlong dev_handle, jstring _host, jstring app_name, jstring con_name, jstring user_pin) {
...
Java_com_qasky_qcard_QTF_getKeyHandle(JNIEnv *env, jobject thiz, jlong dev_handle, jstring app_name, jstring con_name, jstring user_pin, jstring check_code, jstring _flag) {
    char *appName = const_cast<char *>(env->GetStringUTFChars(app_name, JNI_FALSE));
    char *conName = const_cast<char *>(env->GetStringUTFChars(con_name, JNI_FALSE));
    char *userPin = const_cast<char *>(env->GetStringUTFChars(user_pin, JNI_FALSE));
...
extern "C"
JNIEXPORT void JNICALL
Java_com_qasky_qcard_QTF_freeKeyHandle(JNIEnv *env, jobject thiz, jlong dev_handle, jlong key_handle) {
...
Java_com_qasky_qcard_QTF_getSoftKey(JNIEnv *env, jobject thiz, jlong dev_handle, jlong key_handle, jlong key_len) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_qasky_qcard_QTF_encrypt(JNIEnv *env, jobject thiz, jlong dev_handle, jlong key_handle, jbyteArray plain) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_qasky_qcard_QTF_decrypt(JNIEnv *env, jobject thiz, jlong dev_handle, jlong key_handle, jbyteArray cipher) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_qasky_qcard_QTF_exportCert(JNIEnv *env, jobject thiz, jlong dev_handle, jint type, jstring app_name, jstring con_name) {
    char *appName = const_cast<char *>(env->GetStringUTFChars(app_name, JNI_FALSE));
    char *conName = const_cast<char *>(env->GetStringUTFChars(con_name, JNI_FALSE));
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_qasky_qcard_QTF_exportPubKey(JNIEnv *env, jobject thiz, jlong dev_handle, jint type, jstring app_name, jstring con_name) {
    char *appName = const_cast<char *>(env->GetStringUTFChars(app_name, JNI_FALSE));
    char *conName = const_cast<char *>(env->GetStringUTFChars(con_name, JNI_FALSE));
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_qasky_qcard_QTF_verifyAppPIN(JNIEnv *env, jobject thiz, jlong dev_handle, jstring app_name, jstring _pin) {
    char *appName = const_cast<char *>(env->GetStringUTFChars(app_name, JNI_FALSE));
...
Java_com_qasky_qcard_QTF_negoOLBizKey(JNIEnv *env, jobject thiz, jstring _host, jstring device_id, jstring system_id, jstring secret_id, jstring server_id, jstring visit_key_base64, jstring protect_key) {
    char *host = const_cast<char *>(env->GetStringUTFChars(_host, JNI_FALSE));
